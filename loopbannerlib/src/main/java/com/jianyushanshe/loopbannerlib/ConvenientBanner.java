package com.jianyushanshe.loopbannerlib;
...
import com.jianyushanshe.loopbannerlib.adapter.LBPageAdapter;
import com.jianyushanshe.loopbannerlib.helper.LBLoopScaleHelper;
import com.jianyushanshe.loopbannerlib.holder.LBViewHolderCreator;
import com.jianyushanshe.loopbannerlib.listener.LBPageChangeListener;
...
import com.jianyushanshe.loopbannerlib.view.LBLoopViewPager;
...
public class ConvenientBanner<T> extends RelativeLayout {
    ...
    private LBPageAdapter pageAdapter;
    private LBLoopViewPager viewPager;
    private ViewGroup loPageTurningPoint;
    private long autoTurningTime = -1;
    private boolean turning;
    private boolean canTurn = false;
    private boolean canLoop = true;
    private LBLoopScaleHelper cbLoopScaleHelper;
    private LBPageChangeListener pageChangeListener;
    ...
    private void init(Context context) {
        ...
        cbLoopScaleHelper = new LBLoopScaleHelper();
    ...
    public ConvenientBanner setPages(LBViewHolderCreator holderCreator, List<T> datas) {
        this.mDatas = datas;
        pageAdapter = new LBPageAdapter(holderCreator, mDatas, canLoop);
    ...
    public ConvenientBanner setPageIndicator(int[] page_indicatorId) {
        ...
        pageChangeListener = new LBPageChangeListener(mPointViews,
                page_indicatorId);
