package com.jianyushanshe.loopbannerlib.helper;
 ...
 * Description:
 */
public class LBLoopScaleHelper {
    private LBLoopViewPager mRecyclerView;
    ...
    public void attachToRecyclerView(final LBLoopViewPager mRecyclerView) {
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                //这里变换位置实现循环
                LBPageAdapter adapter = (LBPageAdapter) mRecyclerView.getAdapter();
